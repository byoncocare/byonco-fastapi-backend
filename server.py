...
# Initialize logger early (before MongoDB connection)
logging.basicConfig(
    level=logging.INFO,
...
# CORS settings
# Note: FastAPI CORS supports allow_origin_regex for pattern matching
# This allows all Vercel preview domains (https://byonco-*.vercel.app)
origins = [
    "http://localhost:3000",
    "http://localhost:5173",
...
app.add_middleware(
    ...
    allow_origin_regex=r"https://byonco-.*\.vercel\.app",  # Vercel preview domains pattern
